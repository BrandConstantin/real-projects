  ...
  <section class="seccion contenedor">
    ...
    <form action="index.html" method="POST" id="registro" class="registro">
      ...
      <div class="paquetes" id="paquetes">
        ...
        <sectiion class="precios seccion">
              ...
              <li>
                <div class="tabla-precio">
                  ...
                  <div class="orden">
                    ...
                    <input type="number" min="1" id="pase_dia" size="3" placeholder="0">
                  </div>
                </div>
              </li>
              <li>
                <div class="tabla-precio">
                  ...
                  <div class="orden">
                    ...
                    <input type="number" min="1" id="pase_completo" size="3" placeholder="0">
                  </div>
                </div>
              </li>
              <li>
                <div class="tabla-precio">
                  ...
                  <div class="orden">
                    ...
                    <input type="number" min="1" id="pase_dosdias" size="3" placeholder="0">
                  </div>
                </div>
              </li>
            </ul>
      ...
      <div class="rezumen clearfix" id="rezumen">
        <h3>Pago y Extras</h3>
        <div class="caja clearfix">
          <div class="extras">
            <div class="orden">
              <label for="camisa_evento">Camisa del evento 10€ <small>(promoción 7% dto.)</small></label>
              <input type="number" min="1" id="camisa_evento" size="3" placeholder="0">
            </div>
            <div class="orden">
              <label for="etiquetas">Paquete de 10 etiquetas 6€ <small>(HTML5, CSS3, JavaScript)</small></label>
              <input type="number" min="1" id="etiquetas" size="3" placeholder="0">
            </div>
            <div class="orden">
              <label for="regalo">Seleccione el regalo</label><br/>
              <select name="regalo" id="regalo" class="regalo" required>
                <option value="">- Seleccion una opción -</option>
                <option value="ETI">Etiquetas</option>
                <option value="PUL">Pulsera</option>
                <option value="EST">Estilografos</option>
              </select>
            </div>
          ...
          <div class="total">
            ...
            <input type="submit" class="button" value="Pagar" id="btnRegistro" disabled>
          </div>
        </div>
      </div>
    </form>
